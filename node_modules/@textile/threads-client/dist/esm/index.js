...
import { bytesFromAddr, bytesToOptions, bytesToTuples, stringFromBytes, } from "@textile/multiaddr";
import { ThreadKey } from "@textile/security";
import * as pb from "@textile/threads-client-grpc/threads_pb";
import { API, } from "@textile/threads-client-grpc/threads_pb_service";
import { ThreadID } from "@textile/threads-id";
import toJsonSchema from "to-json-schema";
import { Query, ReadTransaction, Where, WriteTransaction, } from "./models";
export { Query, Where, WriteTransaction, ReadTransaction, };
...
export function maybeLocalAddr(ip) {
...
export class Client {
     ...
     * ```
     */
    static withUserAuth(auth, host = defaultHost, debug = false) {
     ...
     * ```
     */
    static withKeyInfo(key, host = defaultHost, debug = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Client(yield new Context(host).withKeyInfo(key), debug);
        });
    }
    /**
    ...
    getTokenChallenge(publicKey, callback, ctx) {
        const client = grpc.client(API.GetToken, {
     ...
     */
    newDB(threadID, name) {
        const dbID = threadID !== null && threadID !== void 0 ? threadID : ThreadID.fromRandom();
    ...
    open(threadID, name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const found = yield this.unary(API.ListDBs, req, (res) => {
    ...
    listDBs() {
        const req = new pb.ListDBsRequest();
        return this.unary(API.ListDBs, req, (res) => {
            var _a;
            const dbs = {};
            for (const db of res.getDbsList()) {
                const id = ThreadID.fromBytes(db.getDbid_asU8()).toString();
                dbs[id] = (_a = db.getInfo()) === null || _a === void 0 ? void 0 : _a.toObject();
            }
            return dbs;
        });
    }
    ...
    listCollections(thread) {
        ...
        return this.unary(API.ListCollections, req, (res) => res.toObject().collectionsList);
    }
    /**
    ...
    getCollectionIndexes(threadID, name) {
        ...
        req.setDbid(threadID.toBytes());
        req.setName(name);
        return this.unary(API.GetCollectionIndexes, req, (res) => res.toObject().indexesList);
    }
    getCollectionInfo(threadID, name) {
        const req = new pb.GetCollectionInfoRequest();
        req.setDbid(threadID.toBytes());
        req.setName(name);
        return this.unary(API.GetCollectionInfo, req, (res) => {
            const result = {
    ...
    newDBFromAddr(address, key, collections) {
        ...
        return this.unary(API.NewDBFromAddr, req, ( /** res: pb.NewDBReply */) => {
            ...
            const result = bytesToTuples(req.getAddr_asU8()).filter(([key]) => key === 406);
    ...
    joinFromInfo(info, includeLocal = false, collections) {
        ...
        const filtered = info.addrs
            .map(bytesFromAddr)
            .filter((addr) => includeLocal || !maybeLocalAddr(bytesToOptions(addr).host));
    ...
    create(threadID, collectionName, values) {
        ...
        return this.unary(API.Create, req, (res) => res.toObject().instanceidsList);
    }
    /**
    ...
    has(threadID, collectionName, IDs) {
        ...
        req.setCollectionname(collectionName);
        req.setInstanceidsList(IDs);
        return this.unary(API.Has, req, (res) => res.getExists());
    }
    /**
    ...
    find(threadID, collectionName, query) {
        ...
        return this.unary(API.Find, req, (res) => {
            return res
    ...
    findByID(threadID, collectionName, ID) {
        ...
        return this.unary(API.FindByID, req, (res) => JSON.parse(decoder.decode(res.getInstance_asU8())));
    }
    /**
